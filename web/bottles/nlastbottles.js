(function (bke) {
  ...
  var bottleinfo = function () {
    return m(".el-bottleinfo", [
      m("h1.bottleinfo-title", "Bottles in the cabinet:")
    ]);
  };
  ...
  var bottlestats = function (stats) {
    return m(".el-bottleinfo", [
      ...
      m(".bottleinfo-stat", [
        m("h2.bottleinfo-value", stats.inCabinet()),
        m(".bottleinfo-key", "in cabinet")
      ]),
      m(".bottleinfo-stat", [
        m("h2.bottleinfo-value", stats.emptied()),
        m(".bottleinfo-key",  "emptied")
      ]),
      m(".bottleinfo-stat", [
        m("h2.bottleinfo-value", stats.avgLifetime()),
        m(".bottleinfo-key", "avg lifetime in days")
      ])
    ]);
  };
